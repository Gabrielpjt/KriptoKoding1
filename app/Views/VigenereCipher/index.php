...
<div class="container-fluid">
    ...
    <div class="container-fluid">
        ...
        <form action="<?= base_url('VigenereCipher/encryptVigenereCipher') ?>" method="post" enctype="multipart/form-data" id="formText" style="display: none;">
...
<div class="container-fluid mt-5">
    ...
    <div class="container-fluid">
        ...
        <form action="<?= base_url('VigenereCipher/decryptVigenereCipher') ?>" method="post" enctype="multipart/form-data" id="formTextDecrypt" style="display: none;">
