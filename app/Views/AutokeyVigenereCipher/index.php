...
<div class="container-fluid">
    ...
    <div class="container-fluid">
        ...
        <form action="<?= base_url('AutokeyVigenereCipher/encryptAutokeyVigenereCipher') ?>" method="post" enctype="multipart/form-data" id="formText" style="display: none;">
        ...
        <form action="<?= base_url('AutokeyVigenereCipher/encryptAutokeyVigenereCipherfile') ?>" method="post" enctype="multipart/form-data" id="formFile">
...
<div class="container-fluid mt-5">
    ...
    <div class="container-fluid">
        ...
        <form action="<?= base_url('AutokeyVigenereCipher/decryptAutokeyVigenereCipher') ?>" method="post" enctype="multipart/form-data" id="formTextDecrypt" style="display: none;">
        ...
        <form action="<?= base_url('AutokeyVigenereCipher/decryptAutokeyVigenereCipherfile') ?>" method="post" enctype="multipart/form-data" id="formFileDecrypt">
