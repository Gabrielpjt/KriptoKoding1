...
<div class="container-fluid">
    ...
    <div class="container-fluid">
        ...
        <form action="<?= base_url('ProductCipher/encryptProductCipher') ?>" method="post" enctype="multipart/form-data" id="formText" style="display: none;">
        ...
        <form action="<?= base_url('upload/doUploadProductCipher') ?>" method="post" enctype="multipart/form-data" id="formFile">
        ...
        <form action="<?= base_url('ProductCipher/encryptProductCipherfile') ?>" method="post" enctype="multipart/form-data" id="formFile1">
            <div class="form-group">
                <label for="kunci">Kunci:</label>
                <input type="text" class="form-control" id="kunci" name="kunci">
            </div>
...
<div class="container-fluid mt-5">
    ...
    <div class="container-fluid">
        ...
        <form action="<?= base_url('ProductCipher/decryptProductCipher') ?>" method="post" enctype="multipart/form-data" id="formTextDecrypt" style="display: none;">
        ...
        <form action="<?= base_url('ProductCipher/decryptProductCipherfile') ?>" method="post" enctype="multipart/form-data" id="formFile1Decrypt">
            <div class="form-group">
                <label for="kunci">Kunci:</label>
